...
class EnginesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engine" do
    assert_difference("Engine.count") do
      post engines_url, params: { engine: { maintenance_id: @engine.maintenance_id, type_engine: @engine.type_engine } }
    end
  ...
  test "should update engine" do
    patch engine_url(@engine), params: { engine: { maintenance_id: @engine.maintenance_id, type_engine: @engine.type_engine } }
